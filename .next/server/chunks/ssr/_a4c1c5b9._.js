...
"[project]/src/lib/data:5543f3 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$5543f3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:5543f3 [app-ssr] (ecmascript) <text/javascript>");
...
function PricingCard({ plan, isCurrentPlan }) {
    ...
    const handleSubscribe = ()=>{
        if (!user) return;
        startTransition(()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$5543f3__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["subscribeAction"])(plan.id, user.id);
        });
    };
...
//# sourceMappingURL=_a4c1c5b9._.js.map