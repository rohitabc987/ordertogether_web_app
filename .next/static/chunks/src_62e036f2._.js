                ...
                "AuthProvider.useEffect.unsubscribeAuth": async (firebaseUser)=>{
                    if (firebaseUser) {
                        ...
                        if (userId) {
                            ...
                            unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(userDocRef, {
                                "AuthProvider.useEffect.unsubscribeAuth": (doc)=>{
                                    if (doc.exists()) {
                                        setUser({
                                            id: doc.id,
                                            ...doc.data()
...
//# sourceMappingURL=src_62e036f2._.js.map