...
"[project]/src/lib/data:4391a3 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$4391a3__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:4391a3 [app-client] (ecmascript) <text/javascript>");
...
function PricingCard({ plan, isCurrentPlan, isLoggedIn }) {
    ...
    const handleSubscribe = ()=>{
        ...
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$4391a3__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["subscribeAction"])(plan.id, user.id);
            if (result.success) {
                toast({
...
//# sourceMappingURL=src_851a264a._.js.map