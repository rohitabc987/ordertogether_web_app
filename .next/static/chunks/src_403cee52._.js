...
function MyPostCard({ post }) {
    ...
    const handleDelete = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$352526__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deletePostAction"])(post.id);
            if (result.success) {
                toast({
                    title: 'Success',
...
//# sourceMappingURL=src_403cee52._.js.map